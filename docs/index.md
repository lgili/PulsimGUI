...
The recommended runtime baseline is **`pulsim v0.7.2`**.

!!! tip "Reproducible environment"
    In `Preferences → Simulation`, keep `Source = PyPI`, `Target version = v0.7.2`, and `Auto-sync` enabled to maintain consistency across machines.
