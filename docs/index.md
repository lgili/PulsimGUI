...
The recommended runtime baseline is **`pulsim v0.6.3`**.

!!! tip "Reproducible environment"
    In `Preferences → Simulation`, keep `Source = PyPI`, `Target version = v0.6.3`, and `Auto-sync` enabled to maintain consistency across machines.
