...
# Pulsim Studio — the "EDA-grade" dark theme from the
# design_handoff_pulsim_studio/ handoff. Every colour below is mapped
# verbatim from that bundle's pyside6/tokens.py (the C class) so the
# native-widget chrome generated by ``generate_stylesheet`` matches the
# handoff's pulsim_dark.qss, and painter code (schematic QGraphicsScene,
# pyqtgraph pens) that reads these same tokens via the theme stays in sync.
# Surfaces: canvas #16181c / panel #1b1d22 / raised #23262c / field #101216.
# Accent #4d9fff (selection/active), nets+run #3fb950, stop #d23b3b.
PULSIM_STUDIO_DARK_THEME = Theme(
    name="studio_dark",
    display_name="Pulsim Studio",
    is_dark=True,
    colors=ThemeColors(
        # Base surfaces
        background="#16181c",          # CANVAS — window / canvas
        background_alt="#1b1d22",      # PANEL — docks, alt rows
        foreground="#dfe3e9",          # TEXT — strong
        foreground_muted="#9aa0a8",    # DIM — secondary
        # Primary = the blue accent (selection / active tool / focus)
        primary="#4d9fff",
        primary_hover="#6cb0ff",
        primary_pressed="#3a86e6",
        primary_foreground="#0b1117",  # dark text on the light-blue fill
        # Secondary = raised controls
        secondary="#23262c",           # RAISED
        secondary_hover="#2c3037",
        secondary_foreground="#dfe3e9",
        # Status: nets/run green, stop/error red, amber warn, blue info
        success="#3fb950",
        success_background="#11281a",
        error="#d23b3b",
        error_background="#2a1416",
        warning="#e0a23a",
        warning_background="#2a2110",
        info="#4d9fff",
        info_background="#11202e",
        # Borders
        border="#34373d",              # BORDER_SOFT
        border_focus="#4d9fff",
        divider="#262a31",             # BORDER_SUB
        # Inputs (field / inset)
        input_background="#101216",     # FIELD
        input_border="#34373d",
        input_focus_border="#4d9fff",
        input_placeholder="#6f757d",    # FAINT
        # Menubar / toolbar
        toolbar_background="#1b1d22",
        toolbar_border="#0e0f12",       # BORDER_HARD region divider
        menu_background="#202329",      # MENUBAR
        menu_hover="#2c3037",
        menu_separator="#34373d",
        # Panels
        panel_background="#1b1d22",
        panel_header="#202329",
        panel_border="#0e0f12",         # hard region borders
        # Tree (symbol library)
        tree_background="#1b1d22",
        tree_item_hover="#2a2d33",
        tree_item_selected="#22344d",   # ~rgba(77,159,255,.14) flattened
        tree_item_selected_inactive="#23262c",
        # Tabs (editor tab strip blends into canvas)
        tab_background="#15171b",
        tab_active="#16181c",
        tab_hover="#202329",
        tab_border="#34373d",
        # Status bar (dark, mono)
        statusbar_background="#15171b",
        statusbar_foreground="#8b9098",
        # Scrollbars
        scrollbar_background="#16181c",
        scrollbar_handle="#34373d",
        scrollbar_handle_hover="#3f444c",
        # Schematic canvas
        schematic_background="#16181c",
        schematic_grid="#282b32",       # GRID_DOT
        schematic_wire="#3fb950",       # WIRE
        schematic_wire_preview="#4d9fff",
        schematic_component="#d8c79c",  # SYMBOL — cream body stroke
        schematic_component_fill="#191d23",
        schematic_pin="#d8c79c",
        schematic_selection="#4d9fff",
        schematic_text="#dfe3e9",
        # Simulation state
        sim_running="#3fb950",
        sim_paused="#e0a23a",
        sim_stopped="#6f757d",
        ...
        icon_hover="#e6e9ee",
        icon_active="#4d9fff",
        icon_disabled="#4b5058",
        icon_accent="#4d9fff",
        context_icon="#9aa0a8",
        overlay_pin_highlight="#3fb950",
        overlay_alignment_guides="#d23b3b",
        overlay_drop_preview_fill="#4d9fff44",
        overlay_drop_preview_border="#4d9fffcc",
        overlay_minimap_viewport_fill="#4d9fff33",
        overlay_minimap_viewport_border="#4d9fffcc",
        # Plot surfaces (scope) — deep near-black with the handoff grid
        plot_background="#0c1014",
        plot_grid="#23262c",            # PLOT_GRID
        plot_axis="#8d8d8d",
        plot_text="#c9cdd4",
        plot_legend_background="#101216",
        plot_legend_border="#34373d",
    ),
)
...
BUILTIN_THEMES = {
    ...
    "studio_dark": PULSIM_STUDIO_DARK_THEME,
}
